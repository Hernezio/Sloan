			...
			if (isset($_POST['confirmar'])) {
				...
				if (!empty($contraseña) && !empty($numero_carnet)) {
					if ($contraseña === $contraseñaC) {	
						...
						echo "<script>alertOk('conttraseña actualizada con exito')</script>";
						echo "<script>window.location='index.php';</script>";
						//header('location: index.php');
					} else {
						echo '<script language="javascript">alertError("Debes llenar los campos con la misma contraseña");</script>';			
				...
				if (empty($resultado['numero_carnet'])) {
					echo '<script language="javascript">alertError("No se encontró este usuario");</script>';			
			...
			<div class="container-fluid">
				<div class="row">
					<div class="col-sm-6 px-0 d-none d-sm-block">
						<img src="img/cambioContraseña.jpg" alt="500" class="login-img img-fluid">
					</div>
					<div class="col-sm-6 login-section-wrapper">
						<div class="align-items-center text-center align-content-center mt-5">
						...
						<div class="login-wrapper my-auto">
							...
							<form method="post">
								<div class="form-group mt-5">
									<label class="text-dark">Carnet</label>
								...
								<a href="index.php" class="mb-5 m-1 btn btn-block bg-warning text-light">Atras</a>
								<button class="mb-5 m-1 btn btn-block bg-success text-light" id="btnConfirmar" name="confirmar">Guardar</button>
							</form>
						</div>
					</div>
				</div>
