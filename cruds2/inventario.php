                            ...
                            <?php foreach($resultado as $fila):?>
                                <?php 
                                    if ($fila['disponibilidad']==2 || $fila['estado'] == 2) {
                                        ...
                                        $estadoArticulo = "Inactivo";
                                        $txtNombreArticulo = "class = \"h6 text-light bg-danger  \"";
                                        $filaArticuloEnUso = "class = \"h6  table-danger  \"";
                                    } else {
                                        $disponibilidad = "Disponible";
                                        $estadoArticulo = "Activo";
                                        $txtNombreArticulo ="class = \"h6\"";
                                        $filaArticuloEnUso ="class = \"h6\"";
                                    }
                                ?>
                                <tr class="text-center">
                                    <td <?php echo $filaArticuloEnUso; ?> 
                                        scope="row"> <?php echo $fila['id_articulo']; ?> 
                                    </td>
                                    <td <?php echo $filaArticuloEnUso; ?>> 
                                        <?php echo $fila['categoria']; ?> 
                                    </td>
                                    <td <?php echo $txtNombreArticulo; ?>> 
