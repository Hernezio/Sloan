<?php
    ...
    $sentencia_select=$con->prepare('SELECT * FROM incidencias ORDER BY id_incidencia ASC');
                    ...
                    <nav class="navbar navbar-dark align-items-center">
                        ...
                        <div class="collapse navbar-collapse text-center" id="navbarSupportedContent">
                            <ul class="navbar-nav">
                                ...
                                <li class="nav-item"><a class="nav-link text-success h6 disabled" href="inciencia.php">Incidencias</a></li>
                    ...
                    <table class="table table-striped table-hover shadow p-3 mb-5 bg-white rounded">
                        <thead>
                            <tr class="text-center">
                                <th class="h5" scope="col">Id. Incidencia</th>
                                <th class="h5" scope="col">Id. Detalle Devolución</th>
                        ...
                        <tbody>
                            ...
                            <tr class="text-center">
                                <th class="h6" scope="row"><?php echo $fila['id_incidencia']; ?> </th>
                                <td class="h6"><?php echo $fila['id_det_devolucion']; ?> </td>
                                <td class="h6"><?php echo $fila['tipo_incidencia']; ?></td>
