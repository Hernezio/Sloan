                            ...
                            <?php foreach($resultado as $fila):?>
                                <?php 
                                    ...
                                    if($fila['estado_usuario']==1){
                                        ...
                                        $txtUsuario = "class=\"h6\"";
                                        $filaUsuario = "class=\"h6\"";
                                    } else {
                                        $estadoUsuario = "No disponible";
                                        $txtUsuario = "class=\"h6 bg-danger text-white\"";
                                        $filaUsuario = "class=\"h6 table-danger\"";
                                    }
                                ?>
                                <tr class="text-center">
                                    <td <?php echo $filaUsuario; ?> scope="row">
                                        <?php echo $fila['id_usuario']; ?> 
                                    </td>
                                    <td <?php echo $filaUsuario; ?>>
