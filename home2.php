                    ...
                    <div class="container bg-white border shadow p-3 mb-5 bg-white rounded">
                        <div class="row text-center pt-4 pb-lg-4">
                            <div class="col-12 col-md-6 col-lg-4">
                                <h2 class="pb-2"><a href="crudMonitor/devoluciones.php" class="text-info text-decoration-none">Devoluciones</a></h2>
                            ...
                            <div class="col-12 col-md-6 col-lg-4">
                                <h2 class="pb-2"><a href="crudMonitor/prestamo.php" class="text-primary text-decoration-none">Préstamos</a></h2>
                            ...
                            <div class="col-12 col-md-12 col-lg-4">
                                <h2 class="pb-2"><a href="crudMonitor/inciencia.php" class="text-success text-decoration-none">Incidencias </a></h2>
                        ...
                        <div class="row text-center pb-4">
                            <div class="col-lg-6 col-md-6">
                                <h2 class="pb-2"><a href="crudMonitor/inventario.php" class="text-warning text-decoration-none">Inventario</a></h2>
                            ...
                            <div class="col-lg-6 col-md-6">
                                <h2 class="pb-2"><a href="crudMonitor/usuarios.php" class="text-danger text-decoration-none">Usuarios</a></h2>
