<?php
	...
	if (isset($_GET['id_prestamo'])){
		...
		$buscar_registro=$con->prepare('SELECT * FROM prestamos WHERE id_prestamo= :id_prestamo');
		$buscar_registro -> execute(array(':id_prestamo'=>$id_prestamo));
	...
	if (isset($_POST['btn_guardar'])){
		...
		if (!empty ($id_prestamo) && !empty ($id_usuario) && !empty ($id_articulo) && !empty($id_prestamo)){
			$modificar_prestamo= $con-> prepare ('UPDATE prestamos SET 
				id_usuario=:id_usuario,
				id_articulo=:id_articulo WHERE id_prestamo=:id_prestamo');
			$modificar_prestamo-> execute(array( 
	...
	<body style="font-family: 'Lato', sans-serif;">
            ...
            <div class="row bg-warning">
                <div class="col-12">
                    <nav class="navbar navbar-dark align-items-center p-2">
                        ...
                        <h2 class="text-white h2 text-center">Monitor</h2>
                        ...
                        <div class="collapse navbar-collapse text-center" id="navbarSupportedContent">
                            <ul class="navbar-nav">
                                ...
                                <li><div class="dropdown-divider"></div></li>
                                <li class="nav-item"><a class="nav-link text-white h5 fw-bold" href="../ingresoUsuarios.php">Salir</a></li>
                            </ul>
                        </div>
                    </nav>
                </div>
		...
		<div class="container mt-5">
			<div class="row text-center pt-5">
				<h2 class="display-4 text-success" style="font-family: 'Yusei Magic', sans-serif;">Modificar Préstamo</h2>
			</div>
			<div class="row pt-3">
				<div class="col-2"></div>
				<div class="col-8">
					<div class="card border-light">
						...
						<div class="card-body">
							<form class="row g-3" action="" method="POST">
								<div class="col-md-6">
									...
									<select id="inputState" class="form-select h6 text-secondary" name="id_usuario">
								...
								<div class="col-md-6">
									...
									<select id="inputState" class="form-select h6 text-secondary" name="id_articulo">
						...
						<div class="card-footer text-muted text-center pt-3">
							<div class="row align-items-center">
								...
								<div class="col-6">
									<a href="update_prestamo.php" name="btn_cancelar" class="btn btn-outline-success has-danger d-inline">Limpiar</a>
								</div>
							</div>
						</div>
					</div>
