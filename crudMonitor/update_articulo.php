...
<html lang="es">
	...
	<body style="font-family: 'Lato', sans-serif; background: -webkit-radial-gradient(top left, white, #d9ffe3, white);  background-size:cover; height: 100%; background-attachment: fixed; ">
		<!-- Contenedor #1 NAVBAR -->
